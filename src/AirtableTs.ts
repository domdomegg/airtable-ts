...
import {
	type AirtableRecord, type AirtableTsTable, type AirtableTsOptions, type CompleteAirtableTsOptions, type ScanParams,
} from './types';
...
export class AirtableTs {
	...
	private readonly options: CompleteAirtableTsOptions;
